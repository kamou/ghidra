...
#ifndef __PRINTCOFFSETS__
#define __PRINTCOFFSETS__
...
/// and it acts as a factory for producing the PrintCWithOffsets object for emitting c-language tokens.
class PrintCWithOffsetsCapability : public PrintLanguageCapability {
  static PrintCWithOffsetsCapability printCCapability;			///< The singleton instance
  PrintCWithOffsetsCapability(void);					///< Initialize the singleton
  PrintCWithOffsetsCapability(const PrintCWithOffsetsCapability &op2);		///< Not implemented
  PrintCWithOffsetsCapability &operator=(const PrintCWithOffsetsCapability &op);	///< Not implemented
public:
...
///  - loop structures
///  - etc.
class PrintCWithOffsets : public PrintLanguage {
protected:
...
public:
  PrintCWithOffsets(Architecture *g,const string &nm="tagged-c-language");	///< Constructor
  ...
  virtual ~PrintCWithOffsets(void) {}

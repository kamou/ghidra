...
OpToken PrintCWithOffsets::hidden = { "", 1, 70, false, OpToken::hiddenfunction, 0, 0, (OpToken *)0 };
OpToken PrintCWithOffsets::scope = { "::", 2, 70, true, OpToken::binary, 0, 0, (OpToken *)0 };
OpToken PrintCWithOffsets::object_member = { ".", 2, 66, true, OpToken::binary, 0, 0, (OpToken *)0  };
OpToken PrintCWithOffsets::pointer_member = { "->", 2, 66, true, OpToken::binary, 0, 0, (OpToken *)0 };
OpToken PrintCWithOffsets::subscript = { "[]", 2, 66, false, OpToken::postsurround, 0, 0, (OpToken *)0 };
OpToken PrintCWithOffsets::function_call = { "()", 2, 66, false, OpToken::postsurround, 0, 10, (OpToken *)0 };
OpToken PrintCWithOffsets::bitwise_not = { "~", 1, 62, false, OpToken::unary_prefix, 0, 0, (OpToken *)0 };
OpToken PrintCWithOffsets::boolean_not = { "!", 1, 62, false, OpToken::unary_prefix, 0, 0, (OpToken *)0 };
OpToken PrintCWithOffsets::unary_minus = { "-", 1, 62, false, OpToken::unary_prefix, 0, 0, (OpToken *)0 };
OpToken PrintCWithOffsets::unary_plus = { "+", 1, 62, false, OpToken::unary_prefix, 0, 0, (OpToken *)0 };
OpToken PrintCWithOffsets::addressof = { "&", 1, 62, false, OpToken::unary_prefix, 0, 0, (OpToken *)0 };
OpToken PrintCWithOffsets::dereference = { "*", 1, 62, false, OpToken::unary_prefix, 0, 0, (OpToken *)0 };
OpToken PrintCWithOffsets::typecast = { "()", 2, 62, false, OpToken::presurround, 0, 0, (OpToken *)0 };
OpToken PrintCWithOffsets::multiply = { "*", 2, 54, true, OpToken::binary, 1, 0, (OpToken *)0 };
OpToken PrintCWithOffsets::divide = { "/", 2, 54, false, OpToken::binary, 1, 0, (OpToken *)0 };
OpToken PrintCWithOffsets::modulo = { "%", 2, 54, false, OpToken::binary, 1, 0, (OpToken *)0 };
OpToken PrintCWithOffsets::binary_plus = { "+", 2, 50, true, OpToken::binary, 1, 0, (OpToken *)0 };
OpToken PrintCWithOffsets::binary_minus = { "-", 2, 50, false, OpToken::binary, 1, 0, (OpToken *)0 };
OpToken PrintCWithOffsets::shift_left = { "<<", 2, 46, false, OpToken::binary, 1, 0, (OpToken *)0 };
OpToken PrintCWithOffsets::shift_right = { ">>", 2, 46, false, OpToken::binary, 1, 0, (OpToken *)0 };
OpToken PrintCWithOffsets::less_than = { "<", 2, 42, false, OpToken::binary, 1, 0, (OpToken *)0 };
OpToken PrintCWithOffsets::less_equal = { "<=", 2, 42, false, OpToken::binary, 1, 0, (OpToken *)0 };
OpToken PrintCWithOffsets::greater_than = { ">", 2, 42, false, OpToken::binary, 1, 0, (OpToken *)0 };
OpToken PrintCWithOffsets::greater_equal = { ">=", 2, 42, false, OpToken::binary, 1, 0, (OpToken *)0 };
OpToken PrintCWithOffsets::equal = { "==", 2, 38, false, OpToken::binary, 1, 0, (OpToken *)0 };
OpToken PrintCWithOffsets::not_equal = { "!=", 2, 38, false, OpToken::binary, 1, 0, (OpToken *)0 };
OpToken PrintCWithOffsets::bitwise_and = { "&", 2, 34, true, OpToken::binary, 1, 0, (OpToken *)0 };
OpToken PrintCWithOffsets::bitwise_xor = { "^", 2, 30, true, OpToken::binary, 1, 0, (OpToken *)0 };
OpToken PrintCWithOffsets::bitwise_or = { "|", 2, 26, true, OpToken::binary, 1, 0, (OpToken *)0 };
OpToken PrintCWithOffsets::boolean_and = { "&&", 2, 22, false, OpToken::binary, 1, 0, (OpToken *)0 };
OpToken PrintCWithOffsets::boolean_xor = { "^^", 2, 20, false, OpToken::binary, 1, 0, (OpToken *)0 };
OpToken PrintCWithOffsets::boolean_or = { "||", 2, 18, false, OpToken::binary, 1, 0, (OpToken *)0 };
OpToken PrintCWithOffsets::assignment = { "=", 2, 14, false, OpToken::binary, 1, 5, (OpToken *)0 };
OpToken PrintCWithOffsets::comma = { ", ", 2, 2, true, OpToken::binary, 0, 0, (OpToken *)0 };
OpToken PrintCWithOffsets::new_op = { "", 2, 62, false, OpToken::space, 1, 0, (OpToken *)0 };

// Inplace assignment operators
OpToken PrintCWithOffsets::multequal = { "*=", 2, 14, false, OpToken::binary, 1, 5, (OpToken *)0 };
OpToken PrintCWithOffsets::divequal = { "/=", 2, 14, false, OpToken::binary, 1, 5, (OpToken *)0 };
OpToken PrintCWithOffsets::remequal = { "%=", 2, 14, false, OpToken::binary, 1, 5, (OpToken *)0 };
OpToken PrintCWithOffsets::plusequal = { "+=", 2, 14, false, OpToken::binary, 1, 5, (OpToken *)0 };
OpToken PrintCWithOffsets::minusequal = { "-=", 2, 14, false, OpToken::binary, 1, 5, (OpToken *)0 };
OpToken PrintCWithOffsets::leftequal = { "<<=", 2, 14, false, OpToken::binary, 1, 5, (OpToken *)0 };
OpToken PrintCWithOffsets::rightequal = { ">>=", 2, 14, false, OpToken::binary, 1, 5, (OpToken *)0 };
OpToken PrintCWithOffsets::andequal = { "&=", 2, 14, false, OpToken::binary, 1, 5, (OpToken *)0 };
OpToken PrintCWithOffsets::orequal = { "|=", 2, 14, false, OpToken::binary, 1, 5, (OpToken *)0 };
OpToken PrintCWithOffsets::xorequal = { "^=", 2, 14, false, OpToken::binary, 1, 5, (OpToken *)0 };

// Operator tokens for type expressions
OpToken PrintCWithOffsets::type_expr_space = { "", 2, 10, false, OpToken::space, 1, 0, (OpToken *)0 };
OpToken PrintCWithOffsets::type_expr_nospace = { "", 2, 10, false, OpToken::space, 0, 0, (OpToken *)0 };
OpToken PrintCWithOffsets::ptr_expr = { "*", 1, 62, false, OpToken::unary_prefix, 0, 0, (OpToken *)0 };
OpToken PrintCWithOffsets::array_expr = { "[]", 2, 66, false, OpToken::postsurround, 1, 0, (OpToken *)0 };
OpToken PrintCWithOffsets::enum_cat = { "|", 2, 26, true, OpToken::binary, 0, 0, (OpToken *)0 };

// Constructing this registers the capability
PrintCWithOffsetsCapability PrintCWithOffsetsCapability::printCCapability;

PrintCWithOffsetsCapability::PrintCWithOffsetsCapability(void)

{
  name = "tagged-c-language";
  isdefault = false;
}

PrintLanguage *PrintCWithOffsetsCapability::buildLanguage(Architecture *glb)

{
  return new PrintCWithOffsets(glb,name);
}

/// \param g is the Architecture owning this c-language emitter
/// \param nm is the name assigned to this emitter
PrintCWithOffsets::PrintCWithOffsets(Architecture *g,const string &nm) : PrintLanguage(g,nm)
...
void PrintCWithOffsets::buildTypeStack(const Datatype *ct,vector<const Datatype *> &typestack)
...
void PrintCWithOffsets::pushPrototypeInputs(const FuncProto *proto)
...
void PrintCWithOffsets::pushTypeStart(const Datatype *ct,bool noident)
...
void PrintCWithOffsets::pushTypeEnd(const Datatype *ct)
...
bool PrintCWithOffsets::checkArrayDeref(const Varnode *vn) const
...
void PrintCWithOffsets::opFunc(const PcodeOp *op)
...
/// \param op is the given PcodeOp
void PrintCWithOffsets::opTypeCast(const PcodeOp *op)
...
/// \param op is the given PcodeOp
void PrintCWithOffsets::opHiddenFunc(const PcodeOp *op)
...
void PrintCWithOffsets::opCopy(const PcodeOp *op)

{
  pushVnImplied(op->getIn(0),op,mods);
}

void PrintCWithOffsets::opLoad(const PcodeOp *op)
...
void PrintCWithOffsets::opStore(const PcodeOp *op)
...
void PrintCWithOffsets::opBranch(const PcodeOp *op)
...
void PrintCWithOffsets::opCbranch(const PcodeOp *op)
...
void PrintCWithOffsets::opBranchind(const PcodeOp *op)
...
void PrintCWithOffsets::opCall(const PcodeOp *op)
...
void PrintCWithOffsets::opCallind(const PcodeOp *op)
...
void PrintCWithOffsets::opCallother(const PcodeOp *op)
...
void PrintCWithOffsets::opConstructor(const PcodeOp *op,bool withNew)
...
void PrintCWithOffsets::opReturn(const PcodeOp *op)
...
void PrintCWithOffsets::opIntZext(const PcodeOp *op)
...
void PrintCWithOffsets::opIntSext(const PcodeOp *op)
...
void PrintCWithOffsets::opBoolNegate(const PcodeOp *op)
...
void PrintCWithOffsets::opSubpiece(const PcodeOp *op)
...
void PrintCWithOffsets::opPtradd(const PcodeOp *op)
...
void PrintCWithOffsets::opPtrsub(const PcodeOp *op)
...
void PrintCWithOffsets::opSegmentOp(const PcodeOp *op)

{
  pushVnImplied(op->getIn(2),op,mods);
}

void PrintCWithOffsets::opCpoolRefOp(const PcodeOp *op)
...
void PrintCWithOffsets::opNewOp(const PcodeOp *op)
...
void PrintCWithOffsets::push_integer(uintb val,int4 sz,bool sign,
...
/// \param vn is the Varnode holding the value
/// \param op is the PcodeOp using the value
void PrintCWithOffsets::push_float(uintb val,int4 sz,const Varnode *vn,const PcodeOp *op)
{
  ostringstream t;
...
void PrintCWithOffsets::printUnicode(ostream &s,int4 onechar) const
...
void PrintCWithOffsets::pushType(const Datatype *ct)
...
/// \param vn is the Varnode holding the value
/// \param op is the PcodeOp using the value
void PrintCWithOffsets::pushBoolConstant(uintb val,const TypeBase *ct,
				 const Varnode *vn,
				 const PcodeOp *op)
{
  if (val != 0)
...
/// while still using the basic PrintCWithOffsets functionality
/// \return \b true if a prefix should be printed
bool PrintCWithOffsets::doEmitWideCharPrefix(void) const
{
  return true;
}
...
bool PrintCWithOffsets::hasCharTerminator(uint1 *buffer,int4 size,int4 charsize)
...
bool PrintCWithOffsets::printCharacterConstant(ostream &s,const Address &addr,int4 charsize) const
...
bool PrintCWithOffsets::isExtensionCastImplied(const PcodeOp *op) const
...
/// \param vn is the Varnode holding the value
/// \param op is the PcodeOp using the value
void PrintCWithOffsets::pushCharConstant(uintb val,const TypeChar *ct,const Varnode *vn,const PcodeOp *op)
...
/// \param vn is the Varnode holding the value
/// \param op is the PcodeOp using the value
void PrintCWithOffsets::pushEnumConstant(uintb val,const TypeEnum *ct,
				 const Varnode *vn,
				 const PcodeOp *op)
{
...
bool PrintCWithOffsets::pushPtrCharConstant(uintb val,const TypePointer *ct,const Varnode *vn,const PcodeOp *op)
...
bool PrintCWithOffsets::pushPtrCodeConstant(uintb val,const TypePointer *ct,
				    const Varnode *vn,
				    const PcodeOp *op)
{
  AddrSpace *spc = glb->getDefaultSpace();
...
void PrintCWithOffsets::pushConstant(uintb val,const Datatype *ct,
			    const Varnode *vn,
			    const PcodeOp *op)
{
  Datatype *subtype;
...
bool PrintCWithOffsets::pushEquate(uintb val,int4 sz,const EquateSymbol *sym,const Varnode *vn,const PcodeOp *op)
...
void PrintCWithOffsets::pushAnnotation(const Varnode *vn,const PcodeOp *op)
...
void PrintCWithOffsets::pushSymbol(const Symbol *sym,const Varnode *vn,const PcodeOp *op)
...
void PrintCWithOffsets::pushUnnamedLocation(const Address &addr,
				   const Varnode *vn,const PcodeOp *op)
{
  ostringstream s;
...
void PrintCWithOffsets::pushPartialSymbol(const Symbol *sym,int4 off,int4 sz,
			       const Varnode *vn,const PcodeOp *op,
			       Datatype *outtype)
{
  ...
  vector<PartialSymbolEntry_> stack;
  ...
  while(ct != (Datatype *)0) {
	...
	stack.push_back(PartialSymbolEntry_());
	PartialSymbolEntry_ &entry( stack.back() );
...
void PrintCWithOffsets::pushMismatchSymbol(const Symbol *sym,int4 off,int4 sz,
				const Varnode *vn,const PcodeOp *op)
{
  if (off==0) {
...
void PrintCWithOffsets::emitStructDefinition(const TypeStruct *ct)
...
void PrintCWithOffsets::emitEnumDefinition(const TypeEnum *ct)
...
void PrintCWithOffsets::emitPrototypeOutput(const FuncProto *proto,
				 const Funcdata *fd)
{
  PcodeOp *op;
  Varnode *vn;
...
void PrintCWithOffsets::emitPrototypeInputs(const FuncProto *proto)
...
void PrintCWithOffsets::emitLocalVarDecls(const Funcdata *fd)
...
void PrintCWithOffsets::emitStatement(const PcodeOp *inst)
...
void PrintCWithOffsets::emitGotoStatement(const FlowBlock *bl,const FlowBlock *exp_bl,
			       uint4 type)
...
void PrintCWithOffsets::adjustTypeOperators(void)

{
  TypeOp::selectJavaOperators(glb->inst,false);
}

void PrintCWithOffsets::setCommentStyle(const string &nm)
...
bool PrintCWithOffsets::isCharacterConstant(const uint1 *buf,int4 size,int4 charsize) const
...
void PrintCWithOffsets::emitTypeDefinition(const Datatype *ct)
...
bool PrintCWithOffsets::checkPrintNegation(const Varnode *vn)
...
void PrintCWithOffsets::docTypeDefinitions(const TypeFactory *typegrp)
...
bool PrintCWithOffsets::emitInplaceOp(const PcodeOp *op)
...
void PrintCWithOffsets::emitExpression(const PcodeOp *op)
...
void PrintCWithOffsets::emitVarDecl(const Symbol *sym)
...
void PrintCWithOffsets::emitVarDeclStatement(const Symbol *sym)
...
bool PrintCWithOffsets::emitScopeVarDecls(const Scope *scope,int4 cat)
...
void PrintCWithOffsets::emitFunctionDeclaration(const Funcdata *fd)
{
...
void PrintCWithOffsets::emitGlobalVarDeclsRecursive(Scope *scope)
...
void PrintCWithOffsets::docAllGlobals(void)
...
void PrintCWithOffsets::docSingleGlobal(const Symbol *sym)
...
void PrintCWithOffsets::docFunction(const Funcdata *fd)
...
void PrintCWithOffsets::emitBlockBasic(const BlockBasic *bb)
...
void PrintCWithOffsets::emitBlockGraph(const BlockGraph *bl)
...
void PrintCWithOffsets::emitBlockCopy(const BlockCopy *bl)
...
void PrintCWithOffsets::emitBlockGoto(const BlockGoto *bl)
...
void PrintCWithOffsets::emitBlockLs(const BlockList *bl)
...
void PrintCWithOffsets::emitBlockCondition(const BlockCondition *bl)
...
void PrintCWithOffsets::emitBlockIf(const BlockIf *bl)
...
void PrintCWithOffsets::emitBlockWhileDo(const BlockWhileDo *bl)
...
void PrintCWithOffsets::emitBlockDoWhile(const BlockDoWhile *bl)
...
void PrintCWithOffsets::emitBlockInfLoop(const BlockInfLoop *bl)
...
void PrintCWithOffsets::emitSwitchCase(int4 casenum,const BlockSwitch *switchbl)
...
void PrintCWithOffsets::emitLabel(const FlowBlock *bl)
...
void PrintCWithOffsets::emitLabelStatement(const FlowBlock *bl)
...
/// \param bl is the given control-flow block
void PrintCWithOffsets::emitAnyLabelStatement(const FlowBlock *bl)
...
void PrintCWithOffsets::emitCommentGroup(const PcodeOp *inst)
...
void PrintCWithOffsets::emitCommentFuncHeader(const Funcdata *fd)
...
void PrintCWithOffsets::emitBlockSwitch(const BlockSwitch *bl)
...
string PrintCWithOffsets::genericFunctionName(const Address &addr)
...
/// \param ct is the given data-type
/// \return the generated name
string PrintCWithOffsets::genericTypeName(const Datatype *ct)
...
void PrintCWithOffsets::pushStatement(Address addr, std::string statement) {
    smap.insert(std::pair<Address, std::string>(addr, statement));
}



map<Address, string> PrintCWithOffsets::getStatementsMap() {
    return smap;
}
